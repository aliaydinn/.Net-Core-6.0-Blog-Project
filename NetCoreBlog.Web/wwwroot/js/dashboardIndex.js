$(document).ready(function () {
    ...
    var totalArticlesUrl = app.Urls.totalArticlesUrl;
    var totalCategoriesUrl = app.Urls.totalCategoriesUrl;
    var totalUsersUrl = app.Urls.totalUsersUrl;

    $.ajax({
        type: "GET",
        url: totalArticlesUrl,
        dataType: "json",
